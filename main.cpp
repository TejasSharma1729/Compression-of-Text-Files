...
string next_block(fstream &f){
    string block; char c;
    for (int i = 0; i < BLOCK_SIZE && f.get(c); i++){
        block += c;
    } return block;
}
...
int main(int argc, char **argv){
    ...
    switch (part) {
        case 3: {use_lz77 = true; break;} // notice the missing break statement. Why is the fall-through useful here?
        case 2: {use_huffman = true; break;}
        case 1: {use_rle = true; break;}
    }
